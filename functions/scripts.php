...
function wpex_load_scripts() {
	...
	*******************/
	...
	// Load Isotope
	wp_enqueue_script('isotope', WPEX_JS_DIR .'/isotope.min.js', array('jquery'), '1.5.19', true);
	wp_enqueue_script('wpex-isotope-blog-init', WPEX_JS_DIR .'/isotope_blog.js', array('jquery'), '1.0', true);
